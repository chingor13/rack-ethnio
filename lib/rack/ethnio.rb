module Rack
  class Ethnio
    ...
    def _call(env)
      ...
      @body.each {|fragment| response.write inject(fragement, @events) }
    ...
    def message(tracker_code)
      %{<script type="text/javascript">(function(){setTimeout(function(){var s = document.createElement('script');s.type="text/javascript";s.async=true;s.src="//ethn.io/remotes/#{@tracker}.js";var x=document.getElementsByTagName('script')[0];x.parentNode.insertBefore(s,x);},1)})();</script>}
    end
